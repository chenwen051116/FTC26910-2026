...
@Config
@TeleOp(name = "Auto PID Line PathChain Test", group = "Pedro Pathing")
public class AutoPIDLinePathChainTest extends OpMode {
    ...
    private void addTelemetry() {
        ...
        telemetry.addData("Path type", "PathChain");
        telemetry.addData("Custom constraints", false);
        telemetry.addData("Global deceleration", false);
