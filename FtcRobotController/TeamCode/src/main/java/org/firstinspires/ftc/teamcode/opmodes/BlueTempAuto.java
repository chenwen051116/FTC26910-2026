...
@Autonomous(name = "BlUETempAuto")
public class BlueTempAuto extends OpMode {
    ...
    private final Pose PrepGather2 = new Pose(-32.0954, 54.0732, 0);

    private final Pose FinishGather2 = new Pose(-2.4513, 54.0732, 0);
