...
public class Constants {
    ...
    public static final double SERVO_RANGE = Math.toRadians(300);
    ...
    public static class Shooter {
        ...
        public static final double[] SHORT_RANGE_HOOD_ANGLE = {
        ...
        public static final double[] LONG_RANGE_HOOD_ANGLE = {
