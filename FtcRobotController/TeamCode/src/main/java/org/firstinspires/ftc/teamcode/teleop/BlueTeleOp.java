...
public class BlueTeleOp extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            toTargetVector = new Vector(shooter.getGoalPose(false).minus(drivetrain.getCurrentPose()));
            ...
            telemetry.addData("Distance to BLUE goal",
                    shooter.getDisplacement(shooter.getGoalPose(false), drivetrain.getCurrentPose()).getMagnitude());
            telemetry.update();
            telemetry.update();
        }
    }
